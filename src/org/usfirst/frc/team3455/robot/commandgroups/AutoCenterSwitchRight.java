 ...
 * 
 */
public class AutoCenterSwitchRight extends CommandGroup {
	
    public AutoCenterSwitchRight() {
    	requires(Robot.chassis);
    	requires(Robot.elevator);
    	requires(Robot.intake);

    	addSequential(new DriveForwardEncoderAuto(12*.5, .35)); //drive forward 0.5 feet
    	...
    	addSequential(new DriveForwardEncoderAuto(12*.5, .35)); //drive forward 0.5 feet to the switch
    	addSequential(new Sleep(250));
